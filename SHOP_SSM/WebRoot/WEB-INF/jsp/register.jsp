...
<script>
	...
	function change(){
		...
		img1.src="${pageContext.request.contextPath}/user/checkImg.do?"+new Date().getTime();
	}
</script>
</head>
<body>
							...
							<tbody>
								...
								<tr>
									...
									<td><sp:password path="password"
											class="text easyui-validatebox tb"
											data-options="required:true" maxlength="20" /> <span>
									</span>
									</td>
								</tr>
								<tr>
									...
									<td><input type="password" id="repassword"
										name="repassword" class="text easyui-validatebox tb"
										data-options="required:true,validType:'equalToPassword[\'#registerForm input[name=password]\']'" maxlength="20"
										 />
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><sp:input path="email"
											class="text easyui-validatebox tb" maxlength="200"
								...
								<tr>
									<th>姓名:</th>
									<td><sp:input path="name"
											class="text easyui-validatebox tb" maxlength="200" /> <span>
									</span>
									</td>
								</tr>
								...
								<tr>
									<th>电话:</th>
									<td><sp:input path="phone"
											type="text easyui-validatebox tb" class="text" />
									</td>
								</tr>

								<tr>
									<th>地址:</th>
									<td><sp:input path="addr"
											type="text easyui-validatebox tb" name="addr" class="text"
											maxlength="200" /> <span> </span>
									</td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>验证码:</th>
									<td><span class="fieldSet"> <input type="text"
											id="checkcode" name="checkcode"
											class="text  easyui-validatebox tb"
											data-options="required:true,validType:'equalToCode[\'${sessionScope.checkcode }\']'" maxlength="4" /><img
											id="checkImg" class="captchaImage"
											src="${pageContext.request.contextPath}/user/checkImg.do"
											onclick="change()" title="点击更换验证码" />
											<input type="hidden" id="code" value=""/> </span>
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
								...
								<tr>
									...
									<td align="left" style="color: red">
										<c:if
											test="${errors !=null && errors.size()>0 }">
