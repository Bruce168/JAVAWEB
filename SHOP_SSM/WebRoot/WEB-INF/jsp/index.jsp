...
<body>
	...
	<div class="container index">
		<div class="span24">
			...
			<img src="<%=basePath%>image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
</div> -->
				<ul class="tabContent" style="display: block;">
					<li><a target="_blank"><img src="<%=basePath%>image/b.jpg"
					...
					<li><a target="_blank"><img src="<%=basePath%>image/c.jpg"
							data-original="http://storage.shopxx.net/demo-image/3.0/201301/51afeef5-f6cb-4936-abea-315cfca0edc0-thumbnail.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/d.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/e.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/f.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/g.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/h.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/i.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/i.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/i.jpg"
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<!-- 					<div class="newProductAd">
									<img src="<%=basePath%>image/q.jpg" width="260" height="343" alt="最新商品" title="最新商品">
						</div>
						 -->
				<ul class="tabContent" style="display: block;">
					<li><a target="_blank"><img src="<%=basePath%>image/l.jpg"
							data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/m.jpg"
							style="display: block;" /> </a></li>

					<li><a target="_blank"><img src="<%=basePath%>image/n.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/o.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/p.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img src="<%=basePath%>image/m.jpg"
							style="display: block;" /> </a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/15.jpg" style="display: block;" /> </a></li>
						<li><a target="_blank"><img
								src="<%=basePath%>image/l.jpg"
