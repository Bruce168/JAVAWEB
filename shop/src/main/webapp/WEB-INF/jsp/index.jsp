			...
			<img src="<%=basePath%>image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					<li><a target="_blank"><img
							src="<%=basePath%>image/b.jpg"
							data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg"
							style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/c.jpg"
							data-original="http://storage.shopxx.net/demo-image/3.0/201301/51afeef5-f6cb-4936-abea-315cfca0edc0-thumbnail.jpg"
							style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/d.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/e.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/f.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/g.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/h.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/i.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/i.jpg" style="display: block;">
					</a></li>
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					...
					<li><a target="_blank"><img
							src="<%=basePath%>image/m.jpg" style="display: block;">
					</a></li>

					<li><a target="_blank"><img
							src="<%=basePath%>image/n.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/o.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/p.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/m.jpg" style="display: block;">
					</a></li>
					<li><a target="_blank"><img
							src="<%=basePath%>image/15.jpg" style="display: block;">
					</a>
						<li><a target="_blank"><img
								src="<%=basePath%>image/l.jpg"
